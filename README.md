...
# Created empty input file "data/inputs/01-2.txt"
# Created empty example file "data/examples/01-2.txt"
# ---
...
# [INFO  aoc_client] 🎅 Saved input to 'data/inputs/01-2.txt'
# ---
# 🎄 Successfully wrote input to "data/inputs/01-2.txt".
